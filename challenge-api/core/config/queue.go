...
import (
	...
	"challenge/core/utils/storage/queue"
	"challenge/core/utils/storage/queue/redisqueue"
...
type Queue struct {
	Redis  *QueueRedis
	Memory *QueueMemory
	NATS   *queue.JetStreamOptions `json:"nats" yaml:"nats"`
...
func (e Queue) Empty() bool {
	return e.Memory == nil && e.Redis == nil && e.NATS == nil && e.NSQ == nil
}
...
func (e Queue) Setup() (storage.AdapterQueue, error) {
	...
	if e.NATS != nil {
		return queue.NewJetStream(e.NATS)
	}
	if e.NSQ != nil {
