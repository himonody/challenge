...
type UserCountryCode struct {
	...
	Code      string     `json:"code" gorm:"column:code;type:varchar(12);uniqueIndex:uk_code;comment:区号"`
	Status    string     `json:"status" gorm:"column:status;type:char(1);index:idx_status;comment:状态(1-可用 2-停用)"`
