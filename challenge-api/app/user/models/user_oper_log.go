...
type AppUserOperLog struct {
	...
	UserID int `gorm:"column:user_id;not null;default:0;comment:用户编号" json:"user_id"`

	ActionType string `gorm:"column:action_type;type:char(2);not null;default:'';comment:用户行为类型" json:"action_type"`
