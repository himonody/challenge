...
type ChallengeCheckinImage struct {
	...
	CheckinId int64      `json:"checkinId" gorm:"column:checkin_id;type:bigint;comment:打卡ID"`
	...
	ImageHash string     `json:"imageHash" gorm:"column:image_hash;type:varchar(64);comment:图片Hash（防重复）"`
