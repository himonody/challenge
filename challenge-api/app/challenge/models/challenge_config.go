...
type ChallengeConfig struct {
	...
	DayCount      int64           `json:"dayCount" gorm:"column:day_count;type:int;uniqueIndex:uk_day_amount,priority:1;comment:挑战天数 1/7/21"`
	Amount        decimal.Decimal `json:"amount" gorm:"column:amount;type:decimal(30,2);uniqueIndex:uk_day_amount,priority:2;comment:单人挑战金额"`
	...
	Status        int64           `json:"status" gorm:"column:status;type:tinyint;index:idx_status;comment:状态 1启用 2停用"`
