...
type ChallengeCheckin struct {
	...
	CheckinDate *time.Time `json:"checkinDate" gorm:"column:checkin_date;type:date;comment:打卡日期 YYYYMMDD"`
	...
	Status      int64      `json:"status" gorm:"column:status;type:tinyint;comment:状态 1成功 2超时"`
