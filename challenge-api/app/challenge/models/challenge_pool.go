...
type ChallengePool struct {
	...
	ConfigId    int64           `json:"configId" gorm:"column:config_id;type:bigint;uniqueIndex:uk_config_date,priority:1;comment:活动配置ID"`
	StartDate   *time.Time      `json:"startDate" gorm:"column:start_date;type:datetime;uniqueIndex:uk_config_date,priority:2;comment:活动开始日期"`
	...
	Settled     int64           `json:"settled" gorm:"column:settled;type:tinyint;index:idx_settled;comment:是否已结算 0否 1是"`
