...
type ChallengeCheckinVideoAd struct {
	...
	CheckinId     int64           `json:"checkinId" gorm:"column:checkin_id;type:bigint;comment:关联打卡ID"`
	...
	AdOrderNo     string          `json:"adOrderNo" gorm:"column:ad_order_no;type:varchar(100);comment:广告联盟返回的订单号（唯一）"`
	...
	VerifyStatus  int64           `json:"verifyStatus" gorm:"column:verify_status;type:tinyint;comment:校验状态 0待校验 1成功 2失败"`
