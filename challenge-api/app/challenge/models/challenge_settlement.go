...
type ChallengeSettlement struct {
	...
	ChallengeId int64           `json:"challengeId" gorm:"column:challenge_id;type:bigint;uniqueIndex:uk_challenge_user,priority:1;comment:用户挑战ID"`
	UserId      int64           `json:"userId" gorm:"column:user_id;type:bigint;uniqueIndex:uk_challenge_user,priority:2;index:idx_user;comment:用户ID"`
