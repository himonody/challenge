...
type ChallengeUser struct {
	...
	UserId          int64           `json:"userId" gorm:"column:user_id;type:bigint;uniqueIndex:uk_user_active,priority:1;comment:用户ID"`
	...
	Status          int64           `json:"status" gorm:"column:status;type:tinyint;uniqueIndex:uk_user_active,priority:2;index:idx_status;comment:状态 1进行中 2成功 3失败"`
