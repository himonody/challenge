...
type RiskEvent struct {
	...
	EventType int64      `json:"eventType" gorm:"column:event_type;type:tinyint;index:idx_event_type_time,priority:1;comment:事件类型"`
	...
	CreatedAt *time.Time `json:"createdAt" gorm:"column:created_at;type:datetime;index:idx_event_type_time,priority:2;comment:发生时间"`
}
