...
type RiskUser struct {
	...
	RiskLevel int64      `json:"riskLevel" gorm:"column:risk_level;type:tinyint;index:idx_risk_level;comment:0正常 1观察 2限制 3封禁"`
	...
	UpdatedAt *time.Time `json:"updatedAt" gorm:"column:updated_at;type:datetime;index:idx_updated_at;comment:更新时间"`
}
